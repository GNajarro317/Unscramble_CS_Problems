...
# Part A
# This will extract the numbers that start with (080)
call_numbers = sorted(set([row[0] for row in calls if row[0].startswith('(080)')]))

# Message is written outside of the loop
print("The numbers called by people in Bangalore have codes:")
# Prints the list of caller numbers
